...
const temVerde = trocandoCores.includes("verde")
console.log("A frase acima tem a cor verde?", temVerde)

const temLaranja = trocandoCores.includes("laranja")
console.log("A frase acima tem a cor laranja?", temLaranja)
